...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "RuyaLLM funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao RuyaLLM",
      description: "Ajude-nos a melhorar o RuyaLLM. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o RuyaLLM?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o RuyaLLM?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o RuyaLLM.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao RuyaLLM, uma ferramenta de IA open-source da Mintplex Labs que transforma qualquer conteúdo em um chatbot treinado. RuyaLLM é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "RuyaLLM é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "RuyaLLM pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. RuyaLLM facilita seu uso.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Você está no caminho para se tornar um expert em RuyaLLM!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do RuyaLLM com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o RuyaLLM.",
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "Nenhuma configuração é necessária ao usar o mecanismo nativo do RuyaLLM.",
    },
  },
  text: {
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o RuyaLLM lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do RuyaLLM. Não são compartilhados com terceiros.",
    },
    pinning: {
