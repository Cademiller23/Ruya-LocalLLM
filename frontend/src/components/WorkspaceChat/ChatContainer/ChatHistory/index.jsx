...
export default function ChatHistory({
  ...
  if (history.length === 0 && !hasAttachments) {
    return (
      <div className="flex flex-col justify-center items-center h-full w-full">
        <h1 className="text-white/80 text-3xl md:text-5xl font-semibold leading-relaxed text-center animate-fadeUpIn">
        Hello <span className="text-ruyaTurquoise-500">{user?.username || ','}</span>< br />
        <span className="text-ruyaPurple-500 font-light">
          Locally I will be able to tend to any of your questions or needs.
        </span>
        </h1>
  ...
  return (
    <div
      className={`markdown text-white/80 font-light ${textSizeClass} h-full md:h-[83%] pb-[100px] pt-6 md:pt-0 md:pb-20 md:mx-0 overflow-y-scroll flex flex-col justify-start ${showScrollbar ? "show-scrollbar" : "no-scroll"}`}
      id="chat-history"
      ref={chatHistoryRef}
