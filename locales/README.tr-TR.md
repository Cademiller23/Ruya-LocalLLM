...
<p align="center">
<b>RuyaLLM:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">  
👉 Masaüstü için RuyaLLM (Mac, Windows ve Linux)! <a href="https://anythingllm.com/download" target="_blank"> Şimdi İndir</a>  
</p>  
...
![Mesajlaşma](https://github.com/Mintplex-Labs/ruya-llm/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
Mintplex Labs ve topluluk, RuyaLLM'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında RuyaLLM kurun →](../BARE_METAL.md)  
...
_Bu uygulamalar Mintplex Labs tarafından yönetilmemektedir, ancak RuyaLLM ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._  
...
- [Coolify](https://coolify.io/docs/services/anythingllm/) - Tek tıklamayla RuyaLLM dağıtımı yapmanıza olanak tanır.  
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - RuyaLLM’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik  

Mintplex Labs Inc. tarafından geliştirilen RuyaLLM, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.  

<details>  
<summary><kbd>RuyaLLM için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>  

### Neden?  

Bu bilgileri, RuyaLLM’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.  
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3AMintplex-Labs%2Fruya-llm%20.sendTelemetry\(&type=code)
