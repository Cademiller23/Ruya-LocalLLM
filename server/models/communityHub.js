...
/**
 * An interface to the RuyaLLM Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the RuyaLLM instance.
  ...
  /**
   * Apply an item to the RuyaLLM instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the RuyaLLM instance by downloading the zip file and importing it.
